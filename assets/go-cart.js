            ...
            return t = GoCart, r = [{
                ...
                value: function(t) {
                    ...
                    window.fetch("/cart/add.js", {
                        ...
                        document.querySelector('.go-cart__mini-cart').classList.remove('empty__cart')
                    }).catch((function(t) {
                        throw e.ajaxRequestFail(), new Error(t)
                    }))
                }
                ...
                key: "cartItemCount",
                value: function(t) {
                    this.cartCount.forEach(elem => {
                        elem.innerHTML = t.item_count
                        if (t.item_count == 0) {
                ...
                value: function() {
                    this.cartMiniCartSubTotal.parentNode.classList.add("is-invisible"), this.cartMiniCart.classList.add('empty__cart'), this.clearMiniCart(), this.cartMiniCartContent.innerHTML = '<div class="go-cart__empty"><div class="link__wrapper"><a class="go_link" href="https://restorative-injectables.myshopify.com/pages/shop">Shop skincare</a></div><div class="link__wrapper"><a class="go_link" href="https://restorative-injectables.myshopify.com/products/digital-gift-cards">Shop gift cards</a></div><div class="link__wrapper"><a class="go_link" href="https://restorative-injectables.myshopify.com/pages/the-beauty-hive">SHOP MEMBERSHIPs</a></div></div>'
                }
            }, {
                key: "clearCartDrawer",
                value: function() {
